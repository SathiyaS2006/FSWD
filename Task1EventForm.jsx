...
function EventForm() {
  ...
  return(
    <form onSubmit={handleSubmit} style={styles.form}>
      ...
      <input type="text" name="name" style={styles.input} placeholder="Enter your name" onChange={handleChange}/>

      <label style={styles.label}>Email</label>
      <input type="email" name="email" style={styles.input} placeholder="Enter your email" onChange={handleChange}/>

      <label style={styles.label}>Password</label>
      <input type="password" name="password" style={styles.input} placeholder="Create password" onChange={handleChange}/>
      ...
      <textarea name="comments" rows="3" style={styles.textarea} placeholder="I'm excited to join!" onChange={handleChange}></textarea>
...
const styles ={
  ...
  heading:{ textAlign:"center", marginBottom:"10px", color:"#d63384", fontWeight:"700" },
  label:{ fontWeight:"600", fontSize:"14px", marginTop:"8px" },
  input:{ width:"100%", padding:"8px", border:"1px solid #bbb", borderRadius:"8px", margin:"5px 0" },
  textarea:{ width:"100%", padding:"8px", borderRadius:"8px", border:"1px solid #bbb", marginTop:"5px" },
  radioGroup:{ display:"flex", gap:"15px", margin:"5px 0" },
  checkbox:{ display:"flex", flexDirection:"column", gap:"4px", margin:"6px 0" },
  fileInput:{ margin:"7px 0" },
  submitBtn:{
    width:"100%", padding:"10px", marginTop:"10px",
    background:"#ff8ac6", color:"#fff", fontWeight:"bold",
